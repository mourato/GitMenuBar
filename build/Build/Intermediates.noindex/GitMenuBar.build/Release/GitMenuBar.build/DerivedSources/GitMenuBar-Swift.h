...
#ifndef GITMENUBAR_SWIFT_H
#define GITMENUBAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GitMenuBar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
@class NSURL;
SWIFT_CLASS("_TtC10GitMenuBar11AppDelegate")

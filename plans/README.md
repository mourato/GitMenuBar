...
|---|---|---:|---:|---|---|---|---|---|---|
| [076](076-workbench-inspector-shell.md) | Add the hidden trailing inspector shell | P0 | M | — | REVIEWED | cfe710e; remediation 6239fb0 | REVIEWER: host:code-review PASS; remediation dispositioned | NONE — merge/push pending operator authorization | NOT_RUN — isolated branch; branch gates passed |

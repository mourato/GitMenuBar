...
- **Rationale**: Fluxo destrutivo de Git com limpeza e recuperação de falhas.
- **Escalate when**: Qualquer mudança em persistência, credenciais, concorrência, release ou comandos fora do fluxo planejado.
